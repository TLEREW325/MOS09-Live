...
Public Class CRXSteelBalances
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXSteelBalances.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXSteelBalances
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXSteelBalances = New CRXSteelBalances()
        rpt.Site = Me.Site
        Return rpt
    End Function
