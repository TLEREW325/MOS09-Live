...
Public Class CRXSalesByItemClass
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CRXSalesByItemClass.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXSalesByItemClass.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXSalesByItemClass
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXSalesByItemClass = New CRXSalesByItemClass()
        rpt.Site = Me.Site
        Return rpt
    End Function
