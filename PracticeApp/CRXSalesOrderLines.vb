...
Public Class CRXSalesOrderLines
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXSalesOrderLines.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXSalesOrderLines
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXSalesOrderLines = New CRXSalesOrderLines()
        rpt.Site = Me.Site
        Return rpt
    End Function
