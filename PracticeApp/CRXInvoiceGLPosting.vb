...
Public Class CRXInvoiceGLPosting
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CRXInvoiceGLPosting.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXInvoiceGLPosting.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXInvoiceGLPosting
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXInvoiceGLPosting = New CRXInvoiceGLPosting()
        rpt.Site = Me.Site
        Return rpt
    End Function
