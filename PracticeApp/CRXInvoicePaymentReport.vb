...
Public Class CRXInvoicePaymentReport
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CRXInvoicePaymentReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXInvoicePaymentReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXInvoicePaymentReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXInvoicePaymentReport = New CRXInvoicePaymentReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
