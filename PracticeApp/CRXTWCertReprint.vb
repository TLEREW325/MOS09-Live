...
Public Class CRXTWCertReprint
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXTWCertReprint.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXTWCertReprint
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXTWCertReprint = New CRXTWCertReprint()
        rpt.Site = Me.Site
        Return rpt
    End Function
