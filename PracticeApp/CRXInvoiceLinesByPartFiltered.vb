...
Public Class CRXInvoiceLinesByPartFiltered
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CRXInvoiceLinesByPartFiltered.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXInvoiceLinesByPartFiltered.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXInvoiceLinesByPartFiltered
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXInvoiceLinesByPartFiltered = New CRXInvoiceLinesByPartFiltered()
        rpt.Site = Me.Site
        Return rpt
    End Function
