...
Public Class CRXTimeSlipPostings
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CRXTimeSlipPostings.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXTimeSlipPostings.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXTimeSlipPostings
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXTimeSlipPostings = New CRXTimeSlipPostings()
        rpt.Site = Me.Site
        Return rpt
    End Function
