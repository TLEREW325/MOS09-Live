...
Public Class CRXQuoteHeaders
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXQuoteHeaders.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXQuoteHeaders
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXQuoteHeaders = New CRXQuoteHeaders()
        rpt.Site = Me.Site
        Return rpt
    End Function
