...
Public Class CRXPTRemittance
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXPTRemittance.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXPTRemittance
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXPTRemittance = New CRXPTRemittance()
        rpt.Site = Me.Site
        Return rpt
    End Function
