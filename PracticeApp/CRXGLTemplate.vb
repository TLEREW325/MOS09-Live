...
Public Class CRXGLTemplate
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXGLTemplate.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXGLTemplate
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXGLTemplate = New CRXGLTemplate()
        rpt.Site = Me.Site
        Return rpt
    End Function
