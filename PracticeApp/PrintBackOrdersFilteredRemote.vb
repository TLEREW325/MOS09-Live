...
Public Class PrintBackOrdersFilteredRemote
    ...
    Private Sub EmailBackorderListingToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles EmailBackorderListingToolStripMenuItem.Click
        'Create new Filename for Backorder Report
        FileDate = Now()
        ...
        TFPMailFilename2 = ""
        TFPMailFilename3 = ""
        TFPMailFilePath = "\\TFP-FS\TransferData\TruweldPackList\BO-" & ConfirmName & ".pdf"
        TFPMailFilePath2 = ""
        TFPMailFilePath3 = ""
        TFPMailTransactionType = "Print Backorder Report"
