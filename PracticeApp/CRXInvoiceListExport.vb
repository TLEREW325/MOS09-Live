...
Public Class CRXInvoiceListExport
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CRXInvoiceListExport.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXInvoiceListExport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXInvoiceListExport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXInvoiceListExport = New CRXInvoiceListExport()
        rpt.Site = Me.Site
        Return rpt
    End Function
