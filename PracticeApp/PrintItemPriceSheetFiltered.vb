...
Public Class PrintItemPriceSheetFiltered
    ...
    Private Sub CRPriceViewer_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CRPriceViewer.Load
        'Loads data into dataset for viewing
        ds = GDS

        'Sets up viewer to display data from the loaded dataset
        Dim MyReport = New CrystalDecisions.CrystalReports.Engine.ReportDocument
        MyReport = CRXItemPriceSheetFiltered1
        MyReport.SetDataSource(ds)
        CRPriceViewer.ReportSource = MyReport
        con.Close()
    End Sub
End Class