...
Public Class CRXPTCheckCanadian
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXPTCheckCanadian.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXPTCheckCanadian
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXPTCheckCanadian = New CRXPTCheckCanadian()
        rpt.Site = Me.Site
        Return rpt
    End Function
