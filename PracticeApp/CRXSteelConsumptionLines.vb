...
Public Class CRXSteelConsumptionLines
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CRXSteelConsumptionLines.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXSteelConsumptionLines.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXSteelConsumptionLines
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXSteelConsumptionLines = New CRXSteelConsumptionLines()
        rpt.Site = Me.Site
        Return rpt
    End Function
