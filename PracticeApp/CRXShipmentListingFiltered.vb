...
Public Class CRXShipmentListingFiltered
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CRXShipmentListingFiltered.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXShipmentListingFiltered.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXShipmentListingFiltered
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXShipmentListingFiltered = New CRXShipmentListingFiltered()
        rpt.Site = Me.Site
        Return rpt
    End Function
