...
Public Class CRXDailyShipmentLog
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CRXDailyShipmentLog.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXDailyShipmentLog.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXDailyShipmentLog
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXDailyShipmentLog = New CRXDailyShipmentLog()
        rpt.Site = Me.Site
        Return rpt
    End Function
