...
Public Class CRXCashReceipts
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXCashReceipts.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXCashReceipts
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXCashReceipts = New CRXCashReceipts()
        rpt.Site = Me.Site
        Return rpt
    End Function
