...
Public Class CRXInv_RackDiscrepancy
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CRXInv-RackDiscrepancy.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXInv-RackDiscrepancy.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXInv_RackDiscrepancy
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXInv_RackDiscrepancy = New CRXInv_RackDiscrepancy()
        rpt.Site = Me.Site
        Return rpt
    End Function
