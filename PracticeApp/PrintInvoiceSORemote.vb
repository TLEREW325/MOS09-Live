...
Public Class PrintInvoiceSORemote
    ...
    Private Sub EmailInvoicesToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles EmailInvoicesToolStripMenuItem.Click
        ...
        TFPMailFilePath2 = ""
        TFPMailFilePath3 = ""
        TFPMailTransactionType = "Print Invoice From SO"
        TFPMailTransactionNumber = GlobalSONumberInvoice
    ...
    Private Sub CRInvoiceViewer_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CRInvoiceViewer.Load
        ...
        cmd.Parameters.Add("@SalesOrderNumber", SqlDbType.VarChar).Value = GlobalSONumberInvoice

        cmd1 = New SqlCommand("SELECT * FROM InvoiceLineQuery WHERE DivisionID = @DivisionID AND SalesOrderNumber = @SalesOrderNumber", con)
        cmd1.Parameters.Add("@DivisionID", SqlDbType.VarChar).Value = GlobalDivisionCode
        cmd1.Parameters.Add("@SalesOrderNumber", SqlDbType.VarChar).Value = GlobalSONumberInvoice
    ...
    Private Sub PrintInvoiceSO_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        EmailInvoiceCustomer = ""
        GlobalSONumberInvoice = 0
    End Sub
End Class