...
Public Class CRXGLArchiveListing
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CRXGLArchiveListing.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXGLArchiveListing.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXGLArchiveListing
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXGLArchiveListing = New CRXGLArchiveListing()
        rpt.Site = Me.Site
        Return rpt
    End Function
