...
Public Class CRXProductionOrder022
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CRXProductionOrder022.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXProductionOrder022.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXProductionOrder022
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXProductionOrder022 = New CRXProductionOrder022()
        rpt.Site = Me.Site
        Return rpt
    End Function
