...
Public Class CRXInventoryCosting
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CRXInventoryCosting.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXInventoryCosting.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXInventoryCosting
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXInventoryCosting = New CRXInventoryCosting()
        rpt.Site = Me.Site
        Return rpt
    End Function
