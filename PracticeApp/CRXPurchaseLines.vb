...
Public Class CRXPurchaseLines
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXPurchaseLines.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXPurchaseLines
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXPurchaseLines = New CRXPurchaseLines()
        rpt.Site = Me.Site
        Return rpt
    End Function
