...
Public Class CRXNegativeInventory
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CRXNegativeInventory.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXNegativeInventory.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXNegativeInventory
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXNegativeInventory = New CRXNegativeInventory()
        rpt.Site = Me.Site
        Return rpt
    End Function
