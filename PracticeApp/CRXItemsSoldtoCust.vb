...
Public Class CRXItemsSoldtoCust
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXItemsSoldtoCust.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXItemsSoldtoCust
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXItemsSoldtoCust = New CRXItemsSoldtoCust()
        rpt.Site = Me.Site
        Return rpt
    End Function
