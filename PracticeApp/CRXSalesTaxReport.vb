...
Public Class CRXSalesTaxReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXSalesTaxReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXSalesTaxReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXSalesTaxReport = New CRXSalesTaxReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
