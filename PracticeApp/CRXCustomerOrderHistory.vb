...
Public Class CRXCustomerOrderHistory
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CRXCustomerOrderHistory.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXCustomerOrderHistory.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXCustomerOrderHistory
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXCustomerOrderHistory = New CRXCustomerOrderHistory()
        rpt.Site = Me.Site
        Return rpt
    End Function
