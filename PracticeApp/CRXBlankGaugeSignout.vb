...
Public Class CRXBlankGaugeSignout
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CRXBlankGaugeSignout.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXBlankGaugeSignout.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXBlankGaugeSignout
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXBlankGaugeSignout = New CRXBlankGaugeSignout()
        rpt.Site = Me.Site
        Return rpt
    End Function
