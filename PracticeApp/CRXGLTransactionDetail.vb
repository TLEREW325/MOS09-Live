...
Public Class CRXGLTransactionDetail
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CRXGLTransactionDetail.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXGLTransactionDetail.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXGLTransactionDetail
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXGLTransactionDetail = New CRXGLTransactionDetail()
        rpt.Site = Me.Site
        Return rpt
    End Function
