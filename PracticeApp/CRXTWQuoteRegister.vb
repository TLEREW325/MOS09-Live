...
Public Class CRXTWQuoteRegister
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXTWQuoteRegister.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXTWQuoteRegister
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXTWQuoteRegister = New CRXTWQuoteRegister()
        rpt.Site = Me.Site
        Return rpt
    End Function
