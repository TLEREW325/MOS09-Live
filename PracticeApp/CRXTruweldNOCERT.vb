...
Public Class CRXTruweldNOCERT
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXTruweldNOCERT.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXTruweldNOCERT
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXTruweldNOCERT = New CRXTruweldNOCERT()
        rpt.Site = Me.Site
        Return rpt
    End Function
