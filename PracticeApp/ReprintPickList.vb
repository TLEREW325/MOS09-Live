...
Public Class ReprintPickList
    ...
    Private Sub EmailPickTicketToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles EmailPickTicketToolStripMenuItem.Click
        ...
        mail.Subject = "Truweld / Trufit Pick Ticket"

        'adding body message information to the mail message
        mail.Body = "This is a Pick Ticket with Truweld / TFP Corporation."

        'adding attachment
        mail.Attachments.Add("\\TFP-FS\TransferData\TruweldPackList\PT-" & ConfirmName & ".pdf")
