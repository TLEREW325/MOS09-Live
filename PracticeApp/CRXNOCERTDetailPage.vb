...
Public Class CRXNOCERTDetailPage
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CRXNOCERTDetailPage.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXNOCERTDetailPage.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXNOCERTDetailPage
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXNOCERTDetailPage = New CRXNOCERTDetailPage()
        rpt.Site = Me.Site
        Return rpt
    End Function
