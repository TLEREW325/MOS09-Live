...
Public Class CRXCustomerReturn
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXCustomerReturn.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXCustomerReturn
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXCustomerReturn = New CRXCustomerReturn()
        rpt.Site = Me.Site
        Return rpt
    End Function
