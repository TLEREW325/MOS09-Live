...
Public Class CRXReturnListing
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXReturnListing.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXReturnListing
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXReturnListing = New CRXReturnListing()
        rpt.Site = Me.Site
        Return rpt
    End Function
