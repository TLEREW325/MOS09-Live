...
Public Class CRXTFNORletter
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXTFNORletter.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXTFNORletter
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXTFNORletter = New CRXTFNORletter()
        rpt.Site = Me.Site
        Return rpt
    End Function
