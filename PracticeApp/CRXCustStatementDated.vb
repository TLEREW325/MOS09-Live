...
Public Class CRXCustStatementDated
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CRXCustStatementDated.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXCustStatementDated.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXCustStatementDated
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXCustStatementDated = New CRXCustStatementDated()
        rpt.Site = Me.Site
        Return rpt
    End Function
