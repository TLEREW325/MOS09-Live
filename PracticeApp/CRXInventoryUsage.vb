...
Public Class CRXInventoryUsage
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXInventoryUsage.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXInventoryUsage
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXInventoryUsage = New CRXInventoryUsage()
        rpt.Site = Me.Site
        Return rpt
    End Function
