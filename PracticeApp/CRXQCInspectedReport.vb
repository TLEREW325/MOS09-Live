...
Public Class CRXQCInspectedReport
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CRXQCInspectedReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXQCInspectedReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXQCInspectedReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXQCInspectedReport = New CRXQCInspectedReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
