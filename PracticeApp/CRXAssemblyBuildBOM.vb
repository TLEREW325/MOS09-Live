...
Public Class CRXAssemblyBuildBOM
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CRXAssemblyBuildBOM.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXAssemblyBuildBOM.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXAssemblyBuildBOM
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXAssemblyBuildBOM = New CRXAssemblyBuildBOM()
        rpt.Site = Me.Site
        Return rpt
    End Function
