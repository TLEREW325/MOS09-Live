...
Public Class CRXWorkOrder
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXWorkOrder.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXWorkOrder
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXWorkOrder = New CRXWorkOrder()
        rpt.Site = Me.Site
        Return rpt
    End Function
