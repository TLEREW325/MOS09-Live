...
Public Class PrintSalesConfirmationRemote
    ...
    Private Sub EmailConfirmationToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles EmailConfirmationToolStripMenuItem.Click
        ...
        TFPMailFilePath = "\\TFP-FS\TransferData\SalesConfirmations\SalesConfirmation" & ConfirmName & ".pdf"
        TFPMailTransactionType = "Print Sales Confirmation"
