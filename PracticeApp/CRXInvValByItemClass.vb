...
Public Class CRXInvValByItemClass
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CRXInvValByItemClass.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXInvValByItemClass.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXInvValByItemClass
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXInvValByItemClass = New CRXInvValByItemClass()
        rpt.Site = Me.Site
        Return rpt
    End Function
