...
Public Class CRXSaltSprayList
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXSaltSprayList.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXSaltSprayList
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXSaltSprayList = New CRXSaltSprayList()
        rpt.Site = Me.Site
        Return rpt
    End Function
