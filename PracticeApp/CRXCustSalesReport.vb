...
Public Class CRXCustSalesReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXCustSalesReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXCustSalesReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXCustSalesReport = New CRXCustSalesReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
