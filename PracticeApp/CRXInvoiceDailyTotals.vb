...
Public Class CRXInvoiceDailyTotals
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CRXInvoiceDailyTotals.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXInvoiceDailyTotals.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXInvoiceDailyTotals
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXInvoiceDailyTotals = New CRXInvoiceDailyTotals()
        rpt.Site = Me.Site
        Return rpt
    End Function
