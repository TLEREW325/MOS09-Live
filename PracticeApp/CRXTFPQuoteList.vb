...
Public Class CRXTFPQuoteList
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXTFPQuoteList.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXTFPQuoteList
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXTFPQuoteList = New CRXTFPQuoteList()
        rpt.Site = Me.Site
        Return rpt
    End Function
