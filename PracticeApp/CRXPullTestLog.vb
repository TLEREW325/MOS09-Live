...
Public Class CRXPullTestLog
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXPullTestLog.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXPullTestLog
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXPullTestLog = New CRXPullTestLog()
        rpt.Site = Me.Site
        Return rpt
    End Function
