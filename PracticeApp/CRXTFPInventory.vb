...
Public Class CRXTFPInventory
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXTFPInventory.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXTFPInventory
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXTFPInventory = New CRXTFPInventory()
        rpt.Site = Me.Site
        Return rpt
    End Function
