...
Public Class CRXSteelSpecialOrders
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CRXSteelSpecialOrders.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXSteelSpecialOrders.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXSteelSpecialOrders
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXSteelSpecialOrders = New CRXSteelSpecialOrders()
        rpt.Site = Me.Site
        Return rpt
    End Function
