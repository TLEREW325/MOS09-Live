...
Public Class CRXShipmentStatus
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXShipmentStatus.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXShipmentStatus
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXShipmentStatus = New CRXShipmentStatus()
        rpt.Site = Me.Site
        Return rpt
    End Function
