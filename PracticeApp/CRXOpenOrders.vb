...
Public Class CRXOpenOrders
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXOpenOrders.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXOpenOrders
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXOpenOrders = New CRXOpenOrders()
        rpt.Site = Me.Site
        Return rpt
    End Function
