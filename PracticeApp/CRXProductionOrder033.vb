...
Public Class CRXProductionOrder033
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CRXProductionOrder033.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXProductionOrder033.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXProductionOrder033
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXProductionOrder033 = New CRXProductionOrder033()
        rpt.Site = Me.Site
        Return rpt
    End Function
