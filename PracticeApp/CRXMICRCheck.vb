...
Public Class CRXMICRCheck
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXMICRCheck.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXMICRCheck
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXMICRCheck = New CRXMICRCheck()
        rpt.Site = Me.Site
        Return rpt
    End Function
