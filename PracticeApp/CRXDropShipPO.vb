...
Public Class CRXDropShipPO
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXDropShipPO.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXDropShipPO
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXDropShipPO = New CRXDropShipPO()
        rpt.Site = Me.Site
        Return rpt
    End Function
