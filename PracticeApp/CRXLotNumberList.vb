...
Public Class CRXLotNumberList
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXLotNumberList.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXLotNumberList
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXLotNumberList = New CRXLotNumberList()
        rpt.Site = Me.Site
        Return rpt
    End Function
