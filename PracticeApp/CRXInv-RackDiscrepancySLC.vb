...
Public Class CRXInv_RackDiscrepancySLC
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CRXInv-RackDiscrepancySLC.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXInv-RackDiscrepancySLC.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXInv_RackDiscrepancySLC
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXInv_RackDiscrepancySLC = New CRXInv_RackDiscrepancySLC()
        rpt.Site = Me.Site
        Return rpt
    End Function
