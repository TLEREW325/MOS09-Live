...
Public Class CRXRackingByFilterNew
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CRXRackingByFilterNew.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXRackingByFilterNew.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXRackingByFilterNew
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXRackingByFilterNew = New CRXRackingByFilterNew()
        rpt.Site = Me.Site
        Return rpt
    End Function
