...
Public Class CRXInvoiceRegister
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXInvoiceRegister.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXInvoiceRegister
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXInvoiceRegister = New CRXInvoiceRegister()
        rpt.Site = Me.Site
        Return rpt
    End Function
