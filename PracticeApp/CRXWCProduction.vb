...
Public Class CRXWCProduction
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXWCProduction.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXWCProduction
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXWCProduction = New CRXWCProduction()
        rpt.Site = Me.Site
        Return rpt
    End Function
