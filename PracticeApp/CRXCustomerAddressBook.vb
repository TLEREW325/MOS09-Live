...
Public Class CRXCustomerAddressBook
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CRXCustomerAddressBook.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXCustomerAddressBook.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXCustomerAddressBook
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXCustomerAddressBook = New CRXCustomerAddressBook()
        rpt.Site = Me.Site
        Return rpt
    End Function
