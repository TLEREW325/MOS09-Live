...
Partial Class PrintOpenSteelPOList
    ...
    End Sub
    Friend WithEvents CROpenSteelPO As CrystalDecisions.Windows.Forms.CrystalReportViewer
    ...
    Friend WithEvents crxOpenSteelPOList1 As MOS09Program.CRXOpenSteelPOList
End Class
