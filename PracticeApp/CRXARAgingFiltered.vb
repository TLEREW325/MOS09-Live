...
Public Class CRXARAgingFiltered
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXARAgingFiltered.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXARAgingFiltered
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXARAgingFiltered = New CRXARAgingFiltered()
        rpt.Site = Me.Site
        Return rpt
    End Function
