...
Public Class CRXRequisition
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXRequisition.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXRequisition
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXRequisition = New CRXRequisition()
        rpt.Site = Me.Site
        Return rpt
    End Function
