...
Public Class CRXSalesbyMonth
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXSalesbyMonth.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXSalesbyMonth
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXSalesbyMonth = New CRXSalesbyMonth()
        rpt.Site = Me.Site
        Return rpt
    End Function
