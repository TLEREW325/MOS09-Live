...
Public Class CRXPrintRackContents
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CRXPrintRackContents.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXPrintRackContents.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXPrintRackContents
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXPrintRackContents = New CRXPrintRackContents()
        rpt.Site = Me.Site
        Return rpt
    End Function
