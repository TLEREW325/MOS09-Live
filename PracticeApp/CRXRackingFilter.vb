...
Public Class CRXRackingFilter
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXRackingFilter.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXRackingFilter
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXRackingFilter = New CRXRackingFilter()
        rpt.Site = Me.Site
        Return rpt
    End Function
