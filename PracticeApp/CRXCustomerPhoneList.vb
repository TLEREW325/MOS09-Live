...
Public Class CRXCustomerPhoneList
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CRXCustomerPhoneList.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXCustomerPhoneList.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXCustomerPhoneList
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXCustomerPhoneList = New CRXCustomerPhoneList()
        rpt.Site = Me.Site
        Return rpt
    End Function
