...
Public Class CRXAPAgingDated
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXAPAgingDated.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXAPAgingDated
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXAPAgingDated = New CRXAPAgingDated()
        rpt.Site = Me.Site
        Return rpt
    End Function
