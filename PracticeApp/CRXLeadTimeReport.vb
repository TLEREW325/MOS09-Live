...
Public Class CRXLeadTimeReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXLeadTimeReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXLeadTimeReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXLeadTimeReport = New CRXLeadTimeReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
