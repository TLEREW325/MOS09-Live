...
Public Class CRXRemittanceReport
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CRXRemittanceReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXRemittanceReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXRemittanceReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXRemittanceReport = New CRXRemittanceReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
