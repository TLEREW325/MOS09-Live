...
Public Class CRXIncomeStatement
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXIncomeStatement.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXIncomeStatement
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXIncomeStatement = New CRXIncomeStatement()
        rpt.Site = Me.Site
        Return rpt
    End Function
