...
Public Class CRXOpenSOLines
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXOpenSOLines.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXOpenSOLines
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXOpenSOLines = New CRXOpenSOLines()
        rpt.Site = Me.Site
        Return rpt
    End Function
