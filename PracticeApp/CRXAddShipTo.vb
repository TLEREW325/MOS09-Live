...
Public Class CRXAddShipTo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXAddShipTo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXAddShipTo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXAddShipTo = New CRXAddShipTo()
        rpt.Site = Me.Site
        Return rpt
    End Function
