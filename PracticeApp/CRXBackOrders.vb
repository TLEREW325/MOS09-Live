...
Public Class CRXBackOrders
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXBackOrders.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXBackOrders
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXBackOrders = New CRXBackOrders()
        rpt.Site = Me.Site
        Return rpt
    End Function
