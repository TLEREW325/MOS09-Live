...
Public Class CRXCustomerNotes
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXCustomerNotes.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXCustomerNotes
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXCustomerNotes = New CRXCustomerNotes()
        rpt.Site = Me.Site
        Return rpt
    End Function
