...
Public Class CRXARPaymentLogFiltered
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CRXARPaymentLogFiltered.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXARPaymentLogFiltered.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXARPaymentLogFiltered
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXARPaymentLogFiltered = New CRXARPaymentLogFiltered()
        rpt.Site = Me.Site
        Return rpt
    End Function
