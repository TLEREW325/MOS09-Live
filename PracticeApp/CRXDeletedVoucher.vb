...
Public Class CRXDeletedVoucher
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXDeletedVoucher.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXDeletedVoucher
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXDeletedVoucher = New CRXDeletedVoucher()
        rpt.Site = Me.Site
        Return rpt
    End Function
