...
Public Class CRXFerruleProductionWorksheet
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CRXFerruleProductionWorksheet.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXFerruleProductionWorksheet.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXFerruleProductionWorksheet
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXFerruleProductionWorksheet = New CRXFerruleProductionWorksheet()
        rpt.Site = Me.Site
        Return rpt
    End Function
