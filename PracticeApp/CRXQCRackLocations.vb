...
Public Class CRXQCRackLocations
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXQCRackLocations.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXQCRackLocations
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXQCRackLocations = New CRXQCRackLocations()
        rpt.Site = Me.Site
        Return rpt
    End Function
