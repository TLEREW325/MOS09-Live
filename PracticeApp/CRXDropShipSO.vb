...
Public Class CRXDropShipSO
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXDropShipSO.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXDropShipSO
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXDropShipSO = New CRXDropShipSO()
        rpt.Site = Me.Site
        Return rpt
    End Function
