...
Public Class CRXAssemblyLines
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXAssemblyLines.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXAssemblyLines
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXAssemblyLines = New CRXAssemblyLines()
        rpt.Site = Me.Site
        Return rpt
    End Function
