...
Public Class CRXSteelReceivingCoilLines
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CRXSteelReceivingCoilLines.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXSteelReceivingCoilLines.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXSteelReceivingCoilLines
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXSteelReceivingCoilLines = New CRXSteelReceivingCoilLines()
        rpt.Site = Me.Site
        Return rpt
    End Function
