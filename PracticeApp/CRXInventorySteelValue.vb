...
Public Class CRXInventorySteelValue
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CRXInventorySteelValue.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXInventorySteelValue.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXInventorySteelValue
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXInventorySteelValue = New CRXInventorySteelValue()
        rpt.Site = Me.Site
        Return rpt
    End Function
