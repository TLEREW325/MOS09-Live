...
Public Class CRXInventoryCoilWIP
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CRXInventoryCoilWIP.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXInventoryCoilWIP.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXInventoryCoilWIP
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXInventoryCoilWIP = New CRXInventoryCoilWIP()
        rpt.Site = Me.Site
        Return rpt
    End Function
