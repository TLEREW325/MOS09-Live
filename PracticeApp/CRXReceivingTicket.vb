...
Public Class CRXReceivingTicket
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXReceivingTicket.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXReceivingTicket
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXReceivingTicket = New CRXReceivingTicket()
        rpt.Site = Me.Site
        Return rpt
    End Function
