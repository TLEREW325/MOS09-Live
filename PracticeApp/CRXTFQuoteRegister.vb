...
Public Class CRXTFQuoteRegister
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXTFQuoteRegister.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXTFQuoteRegister
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXTFQuoteRegister = New CRXTFQuoteRegister()
        rpt.Site = Me.Site
        Return rpt
    End Function
