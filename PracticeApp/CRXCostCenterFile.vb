...
Public Class CRXCostCenterFile
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXCostCenterFile.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXCostCenterFile
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXCostCenterFile = New CRXCostCenterFile()
        rpt.Site = Me.Site
        Return rpt
    End Function
