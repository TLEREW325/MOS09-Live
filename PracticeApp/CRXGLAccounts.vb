...
Public Class CRXGLAccounts
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXGLAccounts.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXGLAccounts
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXGLAccounts = New CRXGLAccounts()
        rpt.Site = Me.Site
        Return rpt
    End Function
