...
Public Class CRXAssemblyListing
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXAssemblyListing.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXAssemblyListing
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXAssemblyListing = New CRXAssemblyListing()
        rpt.Site = Me.Site
        Return rpt
    End Function
