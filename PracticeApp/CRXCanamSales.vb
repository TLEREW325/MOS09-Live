...
Public Class CRXCanamSales
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXCanamSales.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXCanamSales
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXCanamSales = New CRXCanamSales()
        rpt.Site = Me.Site
        Return rpt
    End Function
