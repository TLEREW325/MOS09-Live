...
Public Class CRXElectronicSchedulingBoard
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CRXElectronicSchedulingBoard.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXElectronicSchedulingBoard.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXElectronicSchedulingBoard
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXElectronicSchedulingBoard = New CRXElectronicSchedulingBoard()
        rpt.Site = Me.Site
        Return rpt
    End Function
