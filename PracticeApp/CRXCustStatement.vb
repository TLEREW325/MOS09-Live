...
Public Class CRXCustStatement
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXCustStatement.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXCustStatement
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXCustStatement = New CRXCustStatement()
        rpt.Site = Me.Site
        Return rpt
    End Function
