...
Public Class CRXPickTicketPulledItems
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CRXPickTicketPulledItems.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXPickTicketPulledItems.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXPickTicketPulledItems
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXPickTicketPulledItems = New CRXPickTicketPulledItems()
        rpt.Site = Me.Site
        Return rpt
    End Function
