...
Public Class CRXOkToProcess
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXOkToProcess.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_nbrTotalPallets() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedCRXOkToProcess
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXOkToProcess = New CRXOkToProcess()
        rpt.Site = Me.Site
        Return rpt
    End Function
