...
Public Class CRXPurchaseLinesByPart
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CRXPurchaseLinesByPart.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXPurchaseLinesByPart.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXPurchaseLinesByPart
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXPurchaseLinesByPart = New CRXPurchaseLinesByPart()
        rpt.Site = Me.Site
        Return rpt
    End Function
