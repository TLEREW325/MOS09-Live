...
Partial Class PrintVendorReturnDate
    ...
    Friend WithEvents CRVendorReturnDateViewer As CrystalDecisions.Windows.Forms.CrystalReportViewer
    Friend WithEvents CRXVendorReturnDate1 As MOS09Program.CRXVendorReturnDate
End Class
