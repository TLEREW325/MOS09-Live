...
Public Class CRXInvoiceDiscrepancy
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CRXInvoiceDiscrepancy.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXInvoiceDiscrepancy.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXInvoiceDiscrepancy
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXInvoiceDiscrepancy = New CRXInvoiceDiscrepancy()
        rpt.Site = Me.Site
        Return rpt
    End Function
