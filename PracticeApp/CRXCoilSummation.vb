...
Public Class CRXCoilSummation
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXCoilSummation.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXCoilSummation
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXCoilSummation = New CRXCoilSummation()
        rpt.Site = Me.Site
        Return rpt
    End Function
