...
Public Class CRXPickTicket
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXPickTicket.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXPickTicket
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXPickTicket = New CRXPickTicket()
        rpt.Site = Me.Site
        Return rpt
    End Function
