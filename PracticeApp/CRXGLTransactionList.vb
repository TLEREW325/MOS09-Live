...
Public Class CRXGLTransactionList
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CRXGLTransactionList.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXGLTransactionList.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXGLTransactionList
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXGLTransactionList = New CRXGLTransactionList()
        rpt.Site = Me.Site
        Return rpt
    End Function
