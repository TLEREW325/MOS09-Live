...
Public Class CRXTWSalesbyTerritory
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CRXTWSalesbyTerritory.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXTWSalesbyTerritory.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXTWSalesbyTerritory
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXTWSalesbyTerritory = New CRXTWSalesbyTerritory()
        rpt.Site = Me.Site
        Return rpt
    End Function
