...
Public Class PrintCustomerStatementDatedRemote
    ...
    Private Sub EmailStatementToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles EmailStatementToolStripMenuItem.Click
        'Create new Filename for Customer Statement Dated
        FileDate = Now()
        ...
        TFPMailFilePath = "\\TFP-FS\TransferData\TruweldCustomerStatements\TWCustomerStatement" & ConfirmName & ".pdf"
