...
Public Class CRXSteelInventoryCosting
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CRXSteelInventoryCosting.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXSteelInventoryCosting.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXSteelInventoryCosting
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXSteelInventoryCosting = New CRXSteelInventoryCosting()
        rpt.Site = Me.Site
        Return rpt
    End Function
