...
Public Class CRXRawMaterials
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXRawMaterials.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXRawMaterials
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXRawMaterials = New CRXRawMaterials()
        rpt.Site = Me.Site
        Return rpt
    End Function
