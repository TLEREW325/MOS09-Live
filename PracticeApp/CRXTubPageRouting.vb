...
Public Class CRXTubPageRouting
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXTubPageRouting.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXTubPageRouting
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXTubPageRouting = New CRXTubPageRouting()
        rpt.Site = Me.Site
        Return rpt
    End Function
