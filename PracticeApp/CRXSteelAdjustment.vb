...
Public Class CRXSteelAdjustment
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXSteelAdjustment.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXSteelAdjustment
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXSteelAdjustment = New CRXSteelAdjustment()
        rpt.Site = Me.Site
        Return rpt
    End Function
