...
Public Class EmailAllShippingDocs
    ...
    Private Sub EmailAllShippingDocs_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub CRShippingViewer_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CRShippingViewer.Load
        ...
        mail.Subject = "Packing list, BOL, and Certs for shipment # " + strShipmentNumber

        'adding body message information to the mail message
        If EmailAddress <> "" Then
            mail.Body = "This is an Packing List/BOL/Certs for an order placed with Truweld / TFP Corporation."
        Else
            'Dont add this line
        End If
        ...
        'adding attachment
        mail.Attachments.Add("\\TFP-FS\TransferData\TruweldPackList\" & PackingListName & ".pdf")
        mail.Attachments.Add("\\TFP-FS\TransferData\TruweldPackList\" & BOLName & ".pdf")
        If CheckForCerts = 0 Then
            'Skip certs
        Else
            mail.Attachments.Add("\\TFP-FS\TransferData\TruweldPackList\" & CertName & ".pdf")
        End If
