...
Public Class CRXTWQuoteTFF
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXTWQuoteTFF.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXTWQuoteTFF
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXTWQuoteTFF = New CRXTWQuoteTFF()
        rpt.Site = Me.Site
        Return rpt
    End Function
