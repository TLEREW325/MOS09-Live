...
Public Class CRXBOL_Multiple
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXBOL-Multiple.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXBOL_Multiple
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXBOL_Multiple = New CRXBOL_Multiple()
        rpt.Site = Me.Site
        Return rpt
    End Function
