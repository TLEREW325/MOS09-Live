...
Public Class CRXPurchaseClearing2
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CRXPurchaseClearing2.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXPurchaseClearing2.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Receiving_Date() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedCRXPurchaseClearing2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXPurchaseClearing2 = New CRXPurchaseClearing2()
        rpt.Site = Me.Site
        Return rpt
    End Function
