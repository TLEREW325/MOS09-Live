...
Public Class CRXReceivingHeaders
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CRXReceivingHeaders.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXReceivingHeaders.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXReceivingHeaders
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXReceivingHeaders = New CRXReceivingHeaders()
        rpt.Site = Me.Site
        Return rpt
    End Function
