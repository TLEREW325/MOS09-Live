...
Public Class CRXCheckRegister
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXCheckRegister.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXCheckRegister
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXCheckRegister = New CRXCheckRegister()
        rpt.Site = Me.Site
        Return rpt
    End Function
