...
Public Class CRXInventoryTubTag
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXInventoryTubTag.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXInventoryTubTag
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXInventoryTubTag = New CRXInventoryTubTag()
        rpt.Site = Me.Site
        Return rpt
    End Function
