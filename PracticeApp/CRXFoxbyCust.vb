...
Public Class CRXFoxbyCust
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXFoxbyCust.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXFoxbyCust
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXFoxbyCust = New CRXFoxbyCust()
        rpt.Site = Me.Site
        Return rpt
    End Function
