...
Public Class CRXSteelCurrentCosting
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CRXSteelCurrentCosting.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXSteelCurrentCosting.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXSteelCurrentCosting
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXSteelCurrentCosting = New CRXSteelCurrentCosting()
        rpt.Site = Me.Site
        Return rpt
    End Function
