...
Public Class CRXSteelReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXSteelReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXSteelReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXSteelReport = New CRXSteelReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
