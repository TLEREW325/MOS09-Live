...
Public Class CRXLeadTimes
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXLeadTimes.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXLeadTimes
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXLeadTimes = New CRXLeadTimes()
        rpt.Site = Me.Site
        Return rpt
    End Function
