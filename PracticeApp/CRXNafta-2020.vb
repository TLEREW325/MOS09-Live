...
Public Class CRXNafta_2020
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXNafta-2020.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXNafta_2020
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXNafta_2020 = New CRXNafta_2020()
        rpt.Site = Me.Site
        Return rpt
    End Function
