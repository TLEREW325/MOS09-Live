...
Public Class ViewConsignmentBilling
    ...
    Private Sub ViewConsignmentBilling_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Public Sub ClearDataInDatagrid()
        dgvConsignmentBilling.DataSource = Nothing
    End Sub
    ...
    Public Sub ShowDataByFilters()
        ...
        If chkUseDateRange.Checked = True Then
            ...
            DateFilter = " AND BillDate BETWEEN @BeginDate AND @EndDate"
        Else
            DateFilter = ""
        End If

        cmd = New SqlCommand("SELECT * FROM ConsignmentBillingTable WHERE DivisionID = @DivisionID" + PartFilter + TextFilter + WarehouseFilter + DateFilter, con)
        ...
        dgvConsignmentBilling.DataSource = ds.Tables("ConsignmentBillingTable")
        con.Close()
    End Sub
    ...
    Public Sub LoadTotals()
        ...
        Dim TotalAmountStatement As String = "SELECT SUM(ExtendedAmount) FROM ConsignmentBillingTable WHERE DivisionID = @DivisionID" + PartFilter + TextFilter + WarehouseFilter + DateFilter
        ...
        Dim TotalQuantityStatement As String = "SELECT SUM(QuantityBilled) FROM ConsignmentBillingTable WHERE DivisionID = @DivisionID" + PartFilter + TextFilter + WarehouseFilter + DateFilter
    ...
    Private Sub cmdPrint_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdPrint.Click
        ...
        Using NewPrintConsignmentBilling As New PrintConsignmentBilling
            Dim Result = NewPrintConsignmentBilling.ShowDialog()
        End Using
    End Sub

    Private Sub dgvConsignmentBilling_CellDoubleClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgvConsignmentBilling.CellDoubleClick
        Dim RowInvoiceNumber, RowShipmentNumber, RowSONumber As Integer

        Dim RowIndex As Integer = Me.dgvConsignmentBilling.CurrentCell.RowIndex

        RowInvoiceNumber = Me.dgvConsignmentBilling.Rows(RowIndex).Cells("InvoiceNumberColumn").Value
        RowShipmentNumber = 0
        RowSONumber = 0
