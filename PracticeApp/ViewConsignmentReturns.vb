...
Public Class ViewConsignmentReturns
    ...
    Private Sub ViewConsignmentReturns_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Public Sub ClearDataInDatagrid()
        dgvConsignmentReturns.DataSource = Nothing
    End Sub
    ...
    Public Sub ShowDataByFilters()
        ...
        cmd = New SqlCommand("SELECT * FROM ConsignmentReturnTable WHERE DivisionID = @DivisionID" + PartFilter + TextFilter + WarehouseFilter + DateFilter, con)
        ...
        myAdapter.Fill(ds, "ConsignmentReturnTable")
        dgvConsignmentReturns.DataSource = ds.Tables("ConsignmentReturnTable")
        con.Close()
    End Sub
    ...
    Public Sub LoadTotals()
        ...
        Dim TotalAmountStatement As String = "SELECT SUM(ExtendedAmount) FROM ConsignmentReturnTable WHERE DivisionID = @DivisionID" + PartFilter + TextFilter + WarehouseFilter + DateFilter
        ...
        Dim TotalQuantityStatement As String = "SELECT SUM(QuantityReturned) FROM ConsignmentReturnTable WHERE DivisionID = @DivisionID" + PartFilter + TextFilter + WarehouseFilter + DateFilter
    ...
    Private Sub cmdPrint_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdPrint.Click
        ...
        Using NewPrintConsignmentReturns As New PrintConsignmentReturns
            Dim Result = NewPrintConsignmentReturns.ShowDialog()
        End Using
    End Sub
    ...
    Private Sub dgvConsignmentReturns_CellDoubleClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgvConsignmentReturns.CellDoubleClick
        Dim RowReturnNumber As Integer

        Dim RowIndex As Integer = Me.dgvConsignmentReturns.CurrentCell.RowIndex

        RowReturnNumber = Me.dgvConsignmentReturns.Rows(RowIndex).Cells("ReturnNumberColumn").Value
