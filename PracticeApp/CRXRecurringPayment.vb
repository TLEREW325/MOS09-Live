...
Public Class CRXRecurringPayment
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CRXRecurringPayment.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXRecurringPayment.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXRecurringPayment
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXRecurringPayment = New CRXRecurringPayment()
        rpt.Site = Me.Site
        Return rpt
    End Function
