...
Public Class CRXInvoiceLines
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXInvoiceLines.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXInvoiceLines
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXInvoiceLines = New CRXInvoiceLines()
        rpt.Site = Me.Site
        Return rpt
    End Function
