...
Public Class CRXARAgingDated
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXARAgingDated.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXARAgingDated
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXARAgingDated = New CRXARAgingDated()
        rpt.Site = Me.Site
        Return rpt
    End Function
