...
Public Class CRXSteelList
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXSteelList.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXSteelList
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXSteelList = New CRXSteelList()
        rpt.Site = Me.Site
        Return rpt
    End Function
