...
Public Class CRXSOWorkOrder
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXSOWorkOrder.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXSOWorkOrder
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXSOWorkOrder = New CRXSOWorkOrder()
        rpt.Site = Me.Site
        Return rpt
    End Function
