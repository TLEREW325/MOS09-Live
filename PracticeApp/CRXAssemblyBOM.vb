...
Public Class CRXAssemblyBOM
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXAssemblyBOM.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXAssemblyBOM
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXAssemblyBOM = New CRXAssemblyBOM()
        rpt.Site = Me.Site
        Return rpt
    End Function
