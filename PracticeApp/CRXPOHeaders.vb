...
Public Class CRXPOHeaders
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXPOHeaders.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXPOHeaders
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXPOHeaders = New CRXPOHeaders()
        rpt.Site = Me.Site
        Return rpt
    End Function
