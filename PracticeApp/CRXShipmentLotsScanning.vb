...
Public Class CRXShipmentLotsScanning
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CRXShipmentLotsScanning.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXShipmentLotsScanning.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXShipmentLotsScanning
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXShipmentLotsScanning = New CRXShipmentLotsScanning()
        rpt.Site = Me.Site
        Return rpt
    End Function
