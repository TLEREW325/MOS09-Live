...
Public Class CRXCertErrorReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXCertErrorReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXCertErrorReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXCertErrorReport = New CRXCertErrorReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
