...
Public Class PrintPickTicketsSORemote
    ...
    Private Sub CRPickListViewer_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CRPickListViewer.Load
        ...
        cmd = New SqlCommand("SELECT * FROM PickListHeaderTable WHERE DivisionID = @DivisionID AND SalesOrderHeaderKey = @SalesOrderHeaderKey", con)
        cmd.Parameters.Add("@DivisionID", SqlDbType.VarChar).Value = GlobalDivisionCode
        cmd.Parameters.Add("@SalesOrderHeaderKey", SqlDbType.VarChar).Value = GlobalSONumberPickList
    ...
    Private Sub EmailPickTicketToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles EmailPickTicketToolStripMenuItem.Click
        ...
        TFPMailFilePath = "\\TFP-FS\TransferData\TruweldPackList\Pick" & ConfirmName & ".pdf"
        TFPMailTransactionType = "Print Pick Ticket From SO"
        TFPMailTransactionNumber = 0
        TFPMailFilename2 = ""
        TFPMailFilename3 = ""
        TFPMailFilePath2 = ""
        TFPMailFilePath3 = ""
        TFPMailTransactionNumber = GlobalSONumberPickList
    ...
    Private Sub PrintPickTicketsSO_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        GlobalSONumber = 0
    End Sub
End Class