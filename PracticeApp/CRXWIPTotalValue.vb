...
Public Class CRXWIPTotalValue
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXWIPTotalValue.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXWIPTotalValue
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXWIPTotalValue = New CRXWIPTotalValue()
        rpt.Site = Me.Site
        Return rpt
    End Function
