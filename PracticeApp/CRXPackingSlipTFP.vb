...
Public Class CRXPackingSlipTFP
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXPackingSlipTFP.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXPackingSlipTFP
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXPackingSlipTFP = New CRXPackingSlipTFP()
        rpt.Site = Me.Site
        Return rpt
    End Function
