...
Public Class CRXInventoryTubList
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CRXInventoryTubList.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXInventoryTubList.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXInventoryTubList
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXInventoryTubList = New CRXInventoryTubList()
        rpt.Site = Me.Site
        Return rpt
    End Function
