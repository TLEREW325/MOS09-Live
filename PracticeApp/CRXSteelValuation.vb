...
Public Class CRXSteelValuation
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXSteelValuation.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXSteelValuation
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXSteelValuation = New CRXSteelValuation()
        rpt.Site = Me.Site
        Return rpt
    End Function
