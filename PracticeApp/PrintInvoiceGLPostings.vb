...
Public Class PrintInvoiceGLPostings
    ...
    Private Sub CRInvoiceViewer_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CRInvoiceViewer.Load
        ...
        cmd = New SqlCommand("SELECT * FROM InvoiceGLPostings WHERE InvoiceNumber = @InvoiceNumber AND DivisionID = @DivisionID", con)
        ...
        myAdapter.Fill(ds, "InvoiceGLPostings")

        'Sets up viewer to display data from the loaded dataset
        Dim MyReport = New CrystalDecisions.CrystalReports.Engine.ReportDocument
        MyReport = CRXInvoiceGLPosting1
