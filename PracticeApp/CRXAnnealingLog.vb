...
Public Class CRXAnnealingLog
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXAnnealingLog.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXAnnealingLog
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXAnnealingLog = New CRXAnnealingLog()
        rpt.Site = Me.Site
        Return rpt
    End Function
