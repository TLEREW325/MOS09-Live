...
Public Class CRXSteelWireYardEntry
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CRXSteelWireYardEntry.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXSteelWireYardEntry.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXSteelWireYardEntry
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXSteelWireYardEntry = New CRXSteelWireYardEntry()
        rpt.Site = Me.Site
        Return rpt
    End Function
