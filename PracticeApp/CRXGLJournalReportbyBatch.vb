...
Public Class CRXGLJournalReportbyBatch
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CRXGLJournalReportbyBatch.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXGLJournalReportbyBatch.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXGLJournalReportbyBatch
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXGLJournalReportbyBatch = New CRXGLJournalReportbyBatch()
        rpt.Site = Me.Site
        Return rpt
    End Function
