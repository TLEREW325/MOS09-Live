...
Public Class CRXInvoiceDailyTotalsMonth
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CRXInvoiceDailyTotalsMonth.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXInvoiceDailyTotalsMonth.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Select_Dates() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedCRXInvoiceDailyTotalsMonth
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXInvoiceDailyTotalsMonth = New CRXInvoiceDailyTotalsMonth()
        rpt.Site = Me.Site
        Return rpt
    End Function
