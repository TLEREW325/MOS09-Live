...
Public Class CRXPrintCustomer
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXPrintCustomer.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXPrintCustomer
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXPrintCustomer = New CRXPrintCustomer()
        rpt.Site = Me.Site
        Return rpt
    End Function
