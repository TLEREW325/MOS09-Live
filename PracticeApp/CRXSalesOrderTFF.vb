...
Public Class CRXSalesOrderTFF
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXSalesOrderTFF.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXSalesOrderTFF
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXSalesOrderTFF = New CRXSalesOrderTFF()
        rpt.Site = Me.Site
        Return rpt
    End Function
