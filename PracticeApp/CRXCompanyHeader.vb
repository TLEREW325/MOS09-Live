...
Public Class CRXCompanyHeader
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXCompanyHeader.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXCompanyHeader
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXCompanyHeader = New CRXCompanyHeader()
        rpt.Site = Me.Site
        Return rpt
    End Function
