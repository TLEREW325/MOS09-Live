...
Public Class PrintShipmentConfirmation
    ...
    Private Sub EmailConfirmationToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles EmailConfirmationToolStripMenuItem.Click
        ...
        mail.Subject = "Shipping Confirmation"

        'adding body message information to the mail message
        mail.Body = "This is an acknowledgement for a shipment sent from Truweld / TFP Corporation."

        'adding attachment
        mail.Attachments.Add("\\TFP-FS\TransferData\SalesConfirmations\ShipConfirmation" & ConfirmName & ".pdf")
