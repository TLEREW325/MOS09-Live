...
Public Class CRXInventoryBatch
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXInventoryBatch.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXInventoryBatch
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXInventoryBatch = New CRXInventoryBatch()
        rpt.Site = Me.Site
        Return rpt
    End Function
