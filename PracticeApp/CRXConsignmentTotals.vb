...
Public Class CRXConsignmentTotals
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CRXConsignmentTotals.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXConsignmentTotals.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXConsignmentTotals
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXConsignmentTotals = New CRXConsignmentTotals()
        rpt.Site = Me.Site
        Return rpt
    End Function
