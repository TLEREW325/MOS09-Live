...
Public Class CRXItemPriceSheet
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXItemPriceSheet.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXItemPriceSheet
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXItemPriceSheet = New CRXItemPriceSheet()
        rpt.Site = Me.Site
        Return rpt
    End Function
