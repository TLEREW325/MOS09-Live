...
Public Class CRXAPProcessBatch
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXAPProcessBatch.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXAPProcessBatch
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXAPProcessBatch = New CRXAPProcessBatch()
        rpt.Site = Me.Site
        Return rpt
    End Function
