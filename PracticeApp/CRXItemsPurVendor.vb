...
Public Class CRXItemsPurVendor
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXItemsPurVendor.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXItemsPurVendor
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXItemsPurVendor = New CRXItemsPurVendor()
        rpt.Site = Me.Site
        Return rpt
    End Function
