...
Public Class PrintPickTicketBatchRemote
    ...
    Private Sub PrintPickTicketBatch_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        GlobalPickBatchNumber = 0
        GlobalPickTicketType = ""
        GlobalPickListNumber = 0
        GlobalPrintPickTickets = ""
    End Sub
    ...
    Private Sub EmailPickTicketToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles EmailPickTicketToolStripMenuItem.Click
        ...
        Try
            ...
            MyReport.ExportToDisk(ExportFormatType.PortableDocFormat, "\\TFP-FS\TransferData\TruweldPackList\PT-" & ConfirmName & ".pdf")
        ...
        TFPMailFilename2 = ""
        TFPMailFilename3 = ""
        TFPMailFilePath = "\\TFP-FS\TransferData\TruweldPackList\PT-" & ConfirmName & ".pdf"
        TFPMailFilePath2 = ""
        TFPMailFilePath3 = ""
        TFPMailTransactionType = "Print Pick Ticket"
        TFPMailTransactionNumber = GlobalPickBatchNumber
        TFPMailCustomer = GlobalPickCustomer
    ...
    Private Sub CRPickViewer_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CRPickViewer.Load
        ...
        cmd = New SqlCommand("SELECT * FROM PickListHeaderTable WHERE DivisionID = @DivisionID AND BatchNumber = @BatchNumber", con)
        cmd.Parameters.Add("@DivisionID", SqlDbType.VarChar).Value = GlobalDivisionCode
        cmd.Parameters.Add("@BatchNumber", SqlDbType.VarChar).Value = GlobalPickBatchNumber

        cmd1 = New SqlCommand("SELECT * FROM PickListLineTable WHERE DivisionID = @DivisionID ORDER BY PickListHeaderKey, PickListLineKey", con)
        ...
        If GlobalPrintPickTickets = "AUTOPRINT" Then
