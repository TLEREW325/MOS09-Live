...
Public Class CRXPTCheckType
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXPTCheckType.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXPTCheckType
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXPTCheckType = New CRXPTCheckType()
        rpt.Site = Me.Site
        Return rpt
    End Function
