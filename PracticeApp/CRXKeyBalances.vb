...
Public Class CRXKeyBalances
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXKeyBalances.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXKeyBalances
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXKeyBalances = New CRXKeyBalances()
        rpt.Site = Me.Site
        Return rpt
    End Function
