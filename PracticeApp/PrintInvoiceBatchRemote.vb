...
Public Class PrintInvoiceBatchRemote
    ...
    Private Sub EmailBatchToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles EmailBatchToolStripMenuItem.Click
        'Create new Filename for Invoice Batch
        FileDate = Now()
        ...
        TFPMailFilePath = "\\TFP-FS\TransferData\TruweldInvoices\TWInvoiceBatch" & ConfirmName & ".pdf"
        TFPMailTransactionType = "Print Invoice Batch"
        TFPMailTransactionNumber = GlobalARBatchNumber
