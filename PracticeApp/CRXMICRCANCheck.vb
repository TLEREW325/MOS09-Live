...
Public Class CRXMICRCANCheck
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXMICRCANCheck.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXMICRCANCheck
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXMICRCANCheck = New CRXMICRCANCheck()
        rpt.Site = Me.Site
        Return rpt
    End Function
