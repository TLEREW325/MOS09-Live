...
Public Class CRXNonInventoryItems
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CRXNonInventoryItems.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXNonInventoryItems.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXNonInventoryItems
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXNonInventoryItems = New CRXNonInventoryItems()
        rpt.Site = Me.Site
        Return rpt
    End Function
