...
Public Class CRX1096FormDIV
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRX1096FormDIV.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRX1096FormDIV
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRX1096FormDIV = New CRX1096FormDIV()
        rpt.Site = Me.Site
        Return rpt
    End Function
