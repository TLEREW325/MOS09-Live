...
Public Class ViewConsignmentAdjustments
    ...
    Private Sub ViewConsignmentAdjustments_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Public Sub ClearDataInDatagrid()
        dgvConsignmentAdjustments.DataSource = Nothing
    End Sub
    ...
    Public Sub ShowDataByFilters()
        ...
        cmd = New SqlCommand("SELECT * FROM ConsignmentAdjustmentTable WHERE DivisionID = @DivisionID" + PartFilter + TextFilter + WarehouseFilter + DateFilter, con)
    ...
    Public Sub LoadTotals()
        ...
        Dim TotalAmountStatement As String = "SELECT SUM(ExtendedAmount) FROM ConsignmentAdjustmentTable WHERE DivisionID = @DivisionID" + PartFilter + TextFilter + WarehouseFilter + DateFilter
        ...
        Dim TotalQuantityStatement As String = "SELECT SUM(Quantity) FROM ConsignmentAdjustmentTable WHERE DivisionID = @DivisionID" + PartFilter + TextFilter + WarehouseFilter + DateFilter
