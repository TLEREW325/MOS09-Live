...
Public Class CRXQCInspectionReport
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CRXQCInspectionReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXQCInspectionReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXQCInspectionReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXQCInspectionReport = New CRXQCInspectionReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
