...
Public Class CRXTabletInventory
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXTabletInventory.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXTabletInventory
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXTabletInventory = New CRXTabletInventory()
        rpt.Site = Me.Site
        Return rpt
    End Function
