...
Public Class PrintSalesOrder
    ...
    Private Sub EmailSalesOrderToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles EmailSalesOrderToolStripMenuItem.Click
        ...
        mail.Subject = "TFP Sales Order"

        'adding body message information to the mail message
        mail.Body = "This is a Sales Order placed with Truweld / TFP Corporation."

        'adding attachment
        mail.Attachments.Add("\\TFP-FS\TransferData\SalesConfirmations\SalesOrder" & ConfirmName & ".pdf")
