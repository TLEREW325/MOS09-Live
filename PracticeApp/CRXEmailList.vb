...
Public Class CRXEmailList
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXEmailList.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXEmailList
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXEmailList = New CRXEmailList()
        rpt.Site = Me.Site
        Return rpt
    End Function
