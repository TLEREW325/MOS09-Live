...
Public Class CRXSteelRequirements
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CRXSteelRequirements.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXSteelRequirements.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXSteelRequirements
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXSteelRequirements = New CRXSteelRequirements()
        rpt.Site = Me.Site
        Return rpt
    End Function
