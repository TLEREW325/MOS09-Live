...
Public Class CRXPullTestListing
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXPullTestListing.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXPullTestListing
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXPullTestListing = New CRXPullTestListing()
        rpt.Site = Me.Site
        Return rpt
    End Function
