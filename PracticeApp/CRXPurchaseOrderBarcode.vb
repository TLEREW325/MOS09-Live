...
Public Class CRXPurchaseOrderBarcode
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CRXPurchaseOrderBarcode.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXPurchaseOrderBarcode.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXPurchaseOrderBarcode
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXPurchaseOrderBarcode = New CRXPurchaseOrderBarcode()
        rpt.Site = Me.Site
        Return rpt
    End Function
