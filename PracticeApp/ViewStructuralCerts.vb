    ...
    Public Sub ShowDataByFilter()
        If txtLookLotNum.Text <> "" Or txtSearch.Text <> "" Or txtLookHeatNumber.Text <> "" Or txtLookPartDesc.Text <> "" Or txtLookPartNum.Text <> "" Or txtLookSalesID.Text <> "" Or txtLookVendorView.Text <> "" Or chkDateRange.Checked = True Or chkOpen.Checked = True Or chkPDFScanned.Checked = True Then
            ...
            Else
                ...
                cmd = New SqlCommand("SELECT * FROM StructuralCertTable Where" + PartFilter + LotNumFilter + HeatNumFilter + DescriptionFilter + SalesIDFilter + VendorFilter + PDFStatusFilter + StatusFilter + DateFilter, con)
                cmd.Parameters.Add("@BeginDate", SqlDbType.VarChar).Value = BeginDate
                cmd.Parameters.Add("@EndDate", SqlDbType.VarChar).Value = EndDate
                If con.State = ConnectionState.Closed Then con.Open()
                ds = New DataSet()
        ...
        If canSave() Then
            ...
            If chosenautho = comString Then
                ...
                Try
                    ...
                    Dim status As String
                    If txtLotNumber.Text = "" Or txtHeatNumber.Text = "" Or cboPartNumber.Text = "" Or cboPartDescription.Text = "" Or cboItemClass.Text = "" Then
                        status = "Open"
                    Else
                        status = "Closed"
                    End If
                ...
                End Try
            Else
                MsgBox("Lot Number Does Not Exists")
            End If
        End If
    End Sub
    ...
    Private Sub EmailPDFOfStructCertToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles EmailPDFOfStructCertToolStripMenuItem.Click
        ...
        If File.Exists(structCertExists) Then
            ...
            Else
                ...
                mail.Subject = "Structural Certification: " + txtLotNumber.Text

                'adding body message information to the mail message
                mail.Body = "Structural Cert For " + cboPartDescription.Text

                mail.Attachments.Add("\\TFP-FS\TransferData\StructuralCerts\" + txtLookLotNum.Text + ".pdf")
