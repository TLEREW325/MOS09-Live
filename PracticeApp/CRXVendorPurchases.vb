...
Public Class CRXVendorPurchases
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXVendorPurchases.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXVendorPurchases
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXVendorPurchases = New CRXVendorPurchases()
        rpt.Site = Me.Site
        Return rpt
    End Function
