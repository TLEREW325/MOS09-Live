...
Public Class CRXPackingSlip
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXPackingSlip.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXPackingSlip
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXPackingSlip = New CRXPackingSlip()
        rpt.Site = Me.Site
        Return rpt
    End Function
