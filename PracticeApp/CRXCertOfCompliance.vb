...
Public Class CRXCertOfCompliance
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CRXCertOfCompliance.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXCertOfCompliance.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXCertOfCompliance
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXCertOfCompliance = New CRXCertOfCompliance()
        rpt.Site = Me.Site
        Return rpt
    End Function
