...
Public Class CRXVendorBOL
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXVendorBOL.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXVendorBOL
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXVendorBOL = New CRXVendorBOL()
        rpt.Site = Me.Site
        Return rpt
    End Function
