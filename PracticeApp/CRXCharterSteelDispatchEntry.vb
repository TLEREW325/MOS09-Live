...
Public Class CRXCharterSteelDispatchEntry
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CRXCharterSteelDispatchEntry.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXCharterSteelDispatchEntry.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXCharterSteelDispatchEntry
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXCharterSteelDispatchEntry = New CRXCharterSteelDispatchEntry()
        rpt.Site = Me.Site
        Return rpt
    End Function
