...
Public Class CRXQCShipmentChecks
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CRXQCShipmentChecks.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXQCShipmentChecks.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXQCShipmentChecks
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXQCShipmentChecks = New CRXQCShipmentChecks()
        rpt.Site = Me.Site
        Return rpt
    End Function
