...
Public Class CRXSteelCoilTransfer
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CRXSteelCoilTransfer.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXSteelCoilTransfer.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXSteelCoilTransfer
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXSteelCoilTransfer = New CRXSteelCoilTransfer()
        rpt.Site = Me.Site
        Return rpt
    End Function
