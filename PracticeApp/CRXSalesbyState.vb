...
Public Class CRXSalesbyState
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXSalesbyState.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXSalesbyState
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXSalesbyState = New CRXSalesbyState()
        rpt.Site = Me.Site
        Return rpt
    End Function
