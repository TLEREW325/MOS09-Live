...
Public Class CRXSerialLog
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXSerialLog.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXSerialLog
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXSerialLog = New CRXSerialLog()
        rpt.Site = Me.Site
        Return rpt
    End Function
