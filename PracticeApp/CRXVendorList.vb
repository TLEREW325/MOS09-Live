...
Public Class CRXVendorList
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXVendorList.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXVendorList
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXVendorList = New CRXVendorList()
        rpt.Site = Me.Site
        Return rpt
    End Function
