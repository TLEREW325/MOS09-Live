...
Public Class CRXBalanceSheet
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXBalanceSheet.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXBalanceSheet
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXBalanceSheet = New CRXBalanceSheet()
        rpt.Site = Me.Site
        Return rpt
    End Function
