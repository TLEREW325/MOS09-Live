...
Public Class CRXPickListHeaders
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXPickListHeaders.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXPickListHeaders
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXPickListHeaders = New CRXPickListHeaders()
        rpt.Site = Me.Site
        Return rpt
    End Function
