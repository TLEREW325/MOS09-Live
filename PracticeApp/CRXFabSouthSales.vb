...
Public Class CRXFabSouthSales
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXFabSouthSales.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Select_Date_Range() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedCRXFabSouthSales
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXFabSouthSales = New CRXFabSouthSales()
        rpt.Site = Me.Site
        Return rpt
    End Function
