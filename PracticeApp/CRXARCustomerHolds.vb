...
Public Class CRXARCustomerHolds
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXARCustomerHolds.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXARCustomerHolds
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXARCustomerHolds = New CRXARCustomerHolds()
        rpt.Site = Me.Site
        Return rpt
    End Function
