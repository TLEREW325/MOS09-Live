...
Public Class CRXItemsSoldFiltered
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CRXItemsSoldFiltered.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXItemsSoldFiltered.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXItemsSoldFiltered
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXItemsSoldFiltered = New CRXItemsSoldFiltered()
        rpt.Site = Me.Site
        Return rpt
    End Function
