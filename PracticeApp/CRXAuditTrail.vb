...
Public Class CRXAuditTrail
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXAuditTrail.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXAuditTrail
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXAuditTrail = New CRXAuditTrail()
        rpt.Site = Me.Site
        Return rpt
    End Function
