...
Public Class CRXInventoryActivityReport
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CRXInventoryActivityReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXInventoryActivityReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXInventoryActivityReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXInventoryActivityReport = New CRXInventoryActivityReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
