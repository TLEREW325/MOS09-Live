...
Public Class CRXVendorReturns
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXVendorReturns.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXVendorReturns
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXVendorReturns = New CRXVendorReturns()
        rpt.Site = Me.Site
        Return rpt
    End Function
