...
Public Class CRXGLJournal
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXGLJournal.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXGLJournal
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXGLJournal = New CRXGLJournal()
        rpt.Site = Me.Site
        Return rpt
    End Function
