...
Public Class CRXHeatFileRecord
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXHeatFileRecord.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXHeatFileRecord
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXHeatFileRecord = New CRXHeatFileRecord()
        rpt.Site = Me.Site
        Return rpt
    End Function
