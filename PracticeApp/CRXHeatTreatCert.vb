...
Public Class CRXHeatTreatCert
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXHeatTreatCert.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXHeatTreatCert
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXHeatTreatCert = New CRXHeatTreatCert()
        rpt.Site = Me.Site
        Return rpt
    End Function
