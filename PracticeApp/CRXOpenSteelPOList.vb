...
Public Class CRXOpenSteelPOList
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXOpenSteelPOList.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXOpenSteelPOList
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXOpenSteelPOList = New CRXOpenSteelPOList()
        rpt.Site = Me.Site
        Return rpt
    End Function
