...
Public Class CRXSteelTransactions
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CRXSteelTransactions.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXSteelTransactions.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXSteelTransactions
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXSteelTransactions = New CRXSteelTransactions()
        rpt.Site = Me.Site
        Return rpt
    End Function
