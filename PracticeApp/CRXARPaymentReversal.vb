...
Public Class CRXARPaymentReversal
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CRXARPaymentReversal.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXARPaymentReversal.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXARPaymentReversal
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXARPaymentReversal = New CRXARPaymentReversal()
        rpt.Site = Me.Site
        Return rpt
    End Function
