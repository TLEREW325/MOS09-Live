...
Public Class CRXMonthSnapshot
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXMonthSnapshot.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXMonthSnapshot
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXMonthSnapshot = New CRXMonthSnapshot()
        rpt.Site = Me.Site
        Return rpt
    End Function
