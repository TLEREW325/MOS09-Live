...
Public Class CRXPOShipper
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXPOShipper.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXPOShipper
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXPOShipper = New CRXPOShipper()
        rpt.Site = Me.Site
        Return rpt
    End Function
