...
Public Class CRXSteelPurchaseLines
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CRXSteelPurchaseLines.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXSteelPurchaseLines.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXSteelPurchaseLines
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXSteelPurchaseLines = New CRXSteelPurchaseLines()
        rpt.Site = Me.Site
        Return rpt
    End Function
