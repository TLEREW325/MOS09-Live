...
Public Class CRXPartSalesData
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXPartSalesData.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXPartSalesData
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXPartSalesData = New CRXPartSalesData()
        rpt.Site = Me.Site
        Return rpt
    End Function
