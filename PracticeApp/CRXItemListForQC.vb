...
Public Class CRXItemListForQC
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXItemListForQC.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_FilterByItemClass() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedCRXItemListForQC
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXItemListForQC = New CRXItemListForQC()
        rpt.Site = Me.Site
        Return rpt
    End Function
