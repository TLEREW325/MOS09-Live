...
Public Class PrintPTCheckCanadian
    ...
    Private Sub PrintPTCheck_C_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
