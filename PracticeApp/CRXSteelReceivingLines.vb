...
Public Class CRXSteelReceivingLines
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CRXSteelReceivingLines.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXSteelReceivingLines.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXSteelReceivingLines
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXSteelReceivingLines = New CRXSteelReceivingLines()
        rpt.Site = Me.Site
        Return rpt
    End Function
