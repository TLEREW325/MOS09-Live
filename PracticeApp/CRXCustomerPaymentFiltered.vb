...
Public Class CRXCustomerPaymentFiltered
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CRXCustomerPaymentFiltered.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXCustomerPaymentFiltered.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXCustomerPaymentFiltered
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXCustomerPaymentFiltered = New CRXCustomerPaymentFiltered()
        rpt.Site = Me.Site
        Return rpt
    End Function
