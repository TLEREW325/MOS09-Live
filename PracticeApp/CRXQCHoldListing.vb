...
Public Class CRXQCHoldListing
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXQCHoldListing.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXQCHoldListing
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXQCHoldListing = New CRXQCHoldListing()
        rpt.Site = Me.Site
        Return rpt
    End Function
