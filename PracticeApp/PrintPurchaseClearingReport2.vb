...
Public Class PrintPurchaseClearingReport2
    ...
    Private Sub CRPurchaseViewer_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CRPurchaseViewer.Load
        ...
        cmd = New SqlCommand("SELECT * FROM PurchaseClearingTable WHERE DivisionID = @DivisionID", con)
        ...
        myAdapter.Fill(ds, "PurchaseClearingTable")
        ...
        MyReport = CRXPurchaseClearing21
