...
Public Class CRXHeatNumberLog
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXHeatNumberLog.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXHeatNumberLog
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXHeatNumberLog = New CRXHeatNumberLog()
        rpt.Site = Me.Site
        Return rpt
    End Function
