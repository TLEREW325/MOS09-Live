...
Public Class CRXOpenSOReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXOpenSOReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXOpenSOReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXOpenSOReport = New CRXOpenSOReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
