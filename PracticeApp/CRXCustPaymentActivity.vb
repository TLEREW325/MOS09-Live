...
Public Class CRXCustPaymentActivity
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CRXCustPaymentActivity.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXCustPaymentActivity.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXCustPaymentActivity
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXCustPaymentActivity = New CRXCustPaymentActivity()
        rpt.Site = Me.Site
        Return rpt
    End Function
