...
Public Class CRXInvoiceListing
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXInvoiceListing.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXInvoiceListing
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXInvoiceListing = New CRXInvoiceListing()
        rpt.Site = Me.Site
        Return rpt
    End Function
