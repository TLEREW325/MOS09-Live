...
Public Class CRXItemClass
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXItemClass.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXItemClass
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXItemClass = New CRXItemClass()
        rpt.Site = Me.Site
        Return rpt
    End Function
