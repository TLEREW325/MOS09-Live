...
Public Class CRXFoxbyPromiseDate
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CRXFoxbyPromiseDate.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXFoxbyPromiseDate.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXFoxbyPromiseDate
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXFoxbyPromiseDate = New CRXFoxbyPromiseDate()
        rpt.Site = Me.Site
        Return rpt
    End Function
