...
Public Class ViewVendorReturnLines
    Inherits System.Windows.Forms.Form

    Dim PartFilter, VendorFilter, POFilter, ReturnFilter, StatusFilter, DateFilter As String
    ...
    Private Sub ViewVendorReturnLines_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Public Sub ClearDataInDatagrid()
        dgvVendorReturnLines.DataSource = Nothing
    End Sub
    ...
    Public Sub ShowDataByFilters()
        ...
        cmd = New SqlCommand("SELECT * FROM VendorReturnLineQuery WHERE DivisionID = @DivisionID" + POFilter + VendorFilter + ReturnFilter + PartFilter + StatusFilter + DateFilter, con)
        ...
        myAdapter.Fill(ds, "VendorReturnLineQuery")
        dgvVendorReturnLines.DataSource = ds.Tables("VendorReturnLineQuery")
        con.Close()
    End Sub
    ...
    Private Sub cmdPrintListing_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdPrintListing.Click
        ...
        Using NewPrintVendorReturnLines As New PrintVendorReturnLines
            Dim result = NewPrintVendorReturnLines.ShowDialog()
        End Using
    End Sub

    Private Sub dgvVendorReturnLines_CellDoubleClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgvVendorReturnLines.CellDoubleClick
        Dim RowReturnNumber As Integer
        Dim RowIndex As Integer = Me.dgvVendorReturnLines.CurrentCell.RowIndex

        RowReturnNumber = Me.dgvVendorReturnLines.Rows(RowIndex).Cells("ReturnNumberColumn").Value
