...
Public Class CRXDropShipListing
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXDropShipListing.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXDropShipListing
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXDropShipListing = New CRXDropShipListing()
        rpt.Site = Me.Site
        Return rpt
    End Function
