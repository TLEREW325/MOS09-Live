...
Public Class CRXAPPaidVouchers
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXAPPaidVouchers.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXAPPaidVouchers
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXAPPaidVouchers = New CRXAPPaidVouchers()
        rpt.Site = Me.Site
        Return rpt
    End Function
