...
Public Class CRXAPCheckLogSubreport
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CRXAPCheckLogSubreport.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXAPCheckLogSubreport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXAPCheckLogSubreport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXAPCheckLogSubreport = New CRXAPCheckLogSubreport()
        rpt.Site = Me.Site
        Return rpt
    End Function
