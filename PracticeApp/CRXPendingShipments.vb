...
Public Class CRXPendingShipments
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CRXPendingShipments.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXPendingShipments.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXPendingShipments
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXPendingShipments = New CRXPendingShipments()
        rpt.Site = Me.Site
        Return rpt
    End Function
