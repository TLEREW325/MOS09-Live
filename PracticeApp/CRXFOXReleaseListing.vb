...
Public Class CRXFOXReleaseListing
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CRXFOXReleaseListing.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXFOXReleaseListing.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXFOXReleaseListing
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXFOXReleaseListing = New CRXFOXReleaseListing()
        rpt.Site = Me.Site
        Return rpt
    End Function
