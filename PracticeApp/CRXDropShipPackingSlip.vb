...
Public Class CRXDropShipPackingSlip
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CRXDropShipPackingSlip.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXDropShipPackingSlip.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXDropShipPackingSlip
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXDropShipPackingSlip = New CRXDropShipPackingSlip()
        rpt.Site = Me.Site
        Return rpt
    End Function
