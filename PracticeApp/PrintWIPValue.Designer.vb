...
Partial Class PrintWIPValue
    ...
    Friend WithEvents CRVWIPValue As CrystalDecisions.Windows.Forms.CrystalReportViewer
    Friend WithEvents crxwipValue1 As MOS09Program.CRXWIPValue
End Class
