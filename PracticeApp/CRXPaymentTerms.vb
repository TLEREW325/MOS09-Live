...
Public Class CRXPaymentTerms
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXPaymentTerms.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXPaymentTerms
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXPaymentTerms = New CRXPaymentTerms()
        rpt.Site = Me.Site
        Return rpt
    End Function
