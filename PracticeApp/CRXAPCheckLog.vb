...
Public Class CRXAPCheckLog
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXAPCheckLog.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXAPCheckLog
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXAPCheckLog = New CRXAPCheckLog()
        rpt.Site = Me.Site
        Return rpt
    End Function
