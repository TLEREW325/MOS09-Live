...
Public Class CRX1096MiscForm
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRX1096MiscForm.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRX1096MiscForm
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRX1096MiscForm = New CRX1096MiscForm()
        rpt.Site = Me.Site
        Return rpt
    End Function
