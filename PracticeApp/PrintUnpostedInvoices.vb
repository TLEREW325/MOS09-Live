...
Public Class PrintUnpostedInvoices
    ...
    Private Sub CRInvoiceViewer_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CRInvoiceViewer.Load
        ...
        cmd = New SqlCommand("SELECT * from InvoiceGeneralLedgerLines ORDER BY DivisionID, InvoiceHeaderKey ASC", con)
        ...
        MyReport = CRXUnpostedInvoiceLines1
