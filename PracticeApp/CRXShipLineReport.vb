...
Public Class CRXShipLineReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXShipLineReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXShipLineReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXShipLineReport = New CRXShipLineReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
