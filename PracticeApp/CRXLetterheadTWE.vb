...
Public Class CRXLetterheadTWE
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXLetterheadTWE.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXLetterheadTWE
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXLetterheadTWE = New CRXLetterheadTWE()
        rpt.Site = Me.Site
        Return rpt
    End Function
