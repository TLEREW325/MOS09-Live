...
Public Class CRXInvAdjJournal
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXInvAdjJournal.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXInvAdjJournal
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXInvAdjJournal = New CRXInvAdjJournal()
        rpt.Site = Me.Site
        Return rpt
    End Function
