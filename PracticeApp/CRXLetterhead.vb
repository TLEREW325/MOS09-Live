...
Public Class CRXLetterhead
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXLetterhead.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXLetterhead
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXLetterhead = New CRXLetterhead()
        rpt.Site = Me.Site
        Return rpt
    End Function
