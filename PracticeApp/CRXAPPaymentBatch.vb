...
Public Class CRXAPPaymentBatch
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MOS09Program.CRXAPPaymentBatch.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRXAPPaymentBatch
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRXAPPaymentBatch = New CRXAPPaymentBatch()
        rpt.Site = Me.Site
        Return rpt
    End Function
